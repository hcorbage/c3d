...
export const translations = {
  en: {
    ...
    split: {
      ...
      targetHint: "Leave blank to keep original scale. Set one axis to scale proportionally.",
  ...
  "pt-BR": {
    ...
    split: {
      ...
      targetHint: "Deixe em branco para manter escala original. Defina um eixo para escalar proporcionalmente.",
