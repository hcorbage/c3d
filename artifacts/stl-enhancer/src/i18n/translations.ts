...
export const translations = {
  en: {
    ...
    options: {
      ...
      mergeShellsWarning: "Multiple shells detected — enable this to merge disconnected parts.",
  ...
  "pt-BR": {
    ...
    options: {
      ...
      mergeShellsWarning: "Múltiplas cascas detectadas — ative para mesclar partes desconectadas.",
